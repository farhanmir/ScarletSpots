    ...
    <div className="h-screen w-full flex flex-col bg-gradient-to-br from-zinc-950 via-zinc-900 to-red-950">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        ...
        <div className="relative w-80 h-80 mb-8">
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-zinc-500 font-bold text-lg">S</div>
          <div className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500 font-bold text-lg">W</div>
          <div className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-500 font-bold text-lg">E</div>
