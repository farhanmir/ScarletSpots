...
///
/// `lot` results render a rich variant (icon tile + name + campus/capacity
/// subtitle + trailing `OccupancyPill`). Building / place results keep the
/// simpler one-line layout with a chevron.
