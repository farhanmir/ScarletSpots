...
_SPONSORS: list[Sponsor] = [
    Sponsor(
        ...
        promo_code="MOON20",
        promo_text="20% off one handcrafted drink",
        about="Demo cafe concept serving small-batch coffee flights and late-night study blends.",
    ...
    Sponsor(
        ...
        promo_code="BRICK50",
        promo_text="50% off one signature slice",
        about="Demo pizza brand focused on giant slices, quick pickup, and post-game crowds.",
    ...
    Sponsor(
        ...
        promo_code="CRUNCH20",
        promo_text="20% off one entree combo",
        about="Demo taqueria concept with loaded burritos, fast service, and student specials.",
    ...
    Sponsor(
        ...
        promo_code="CRUST50",
        promo_text="50% off one stuffed panzo",
        about="Demo neighborhood kitchen serving stuffed breads, comfort bowls, and midnight bites.",
