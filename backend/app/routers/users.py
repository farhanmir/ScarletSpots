...
def _profile_to_response(profile: Profile, fallback_email: str | None = None) -> dict:
    ...
    return {
        ...
        "notify_parking_restrictions": bool(profile.notify_parking_restrictions),
        "notify_friend_same_lot": bool(profile.notify_friend_same_lot),
        "notify_auto_park_started": bool(profile.notify_auto_park_started),
        "notify_auto_park_ended": bool(profile.notify_auto_park_ended),
        ...
        "sessions": [
            {
                ...
                "deck_level_label": row.deck_level_label,
                "deck_level_key": row.deck_level_key,
                "altitude_meters": row.altitude_meters,
                "altitude_accuracy_meters": row.altitude_accuracy_meters,
                "active": row.active,
