#!/usr/bin/env python3
"""Build the bundled SQLite database consumed by the iOS-native app.

Reads the canonical JSON files in `ios-native/data-sources/` and writes a
fully-populated `scarletspots.sqlite` into `ios-native/ScarletSpots/Resources/`.
