# ScarletSpots - Rutgers Parking Finder (Web Prototype README)

> **Source**: `readme2.md` — Commit `f5465d3` (Feb 14, 2026)
> **Status**: Historical archive. This described the Figma Make / React/Vite web prototype
>            that existed before the pivot to a native Expo React Native app.
...
- This was a **web application** (not native mobile) built with Figma Make
...
⚠️ **Prototype Status**: This was a prototype built for demonstration. The project has since
pivoted to a native Expo React Native app (see `mobile/` directory) for better sensor access
and a production-grade architecture.
