    ...
    <div className='min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-zinc-950 via-zinc-900 to-red-950'>
      <div className='w-full max-w-md space-y-8'>
        ...
        <form
          ...
          className='space-y-6 bg-zinc-900/50 backdrop-blur-sm p-8 rounded-2xl border border-zinc-800'
        >
          ...
          <div className='mt-4 p-3 bg-zinc-800/50 rounded-lg border border-zinc-700'>
            <p className='text-xs text-zinc-400 text-center'>
              <span className='font-semibold text-zinc-300'>Demo:</span> Create an account with any
              @rutgers.edu email
            </p>
          </div>
        </form>
